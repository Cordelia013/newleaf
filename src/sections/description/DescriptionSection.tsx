    ...
    <section className="py-32 mt-96">
      <div className="container px-4 ">
        ...
        <div className="flex flex-col items-center ">
          <h3 className=" font-Desirable-Brust text-[#CC001E] opacity-60 mix-blend-difference text-[60px] mt-44  font-normal ">
            Hip Hop
          </h3>
          <div className=" w-[410px] opacity-60  text-sm font-['Montserrat'] mt-8  ">
        ...
        <div className="flex flex-col items-center ">
          ...
          <h3 className="font-Desirable-Brust text-center text-[#CC001E] text-8xl block -mt-[548px]">
            Musiciens{" "}
          </h3>
          <div className=" w-[410px] opacity-60  text-sm font-['Montserrat'] mt-16  ">
            Le Lorem Ipsum est simplement du faux texte employé dans la
            composition et la mise en page avant impression. Le Lorem Ipsum est
            le faux texte standard de l'imprimerie depuis les années 1500, quand
            un imprimeur anonyme assembla ensemble des morceaux de texte pour
      ...
      <div className="relative top-18">
        <h1 className="font-Desirable-Sans text-[8rem] leading-none ">
          sch
          <br />{" "}
          <span className="font-Desirable-Brust ml-14 text-[#CC001E] text-4xl block -mt-8">
            Artiste
          </span>
        </h1>
